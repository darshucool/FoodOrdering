...
namespace MIMS.Security
{
    ...
    public class ExternalUserRedirectAttribute : AuthorizeAttribute
    {
        public override void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            {
                filterContext.Result = new RedirectToRouteResult(new RouteValueDictionary(new { controller = "ExternalHome" }));
            }
        }
